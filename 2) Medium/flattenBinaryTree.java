...
//Another important thing to remember is that we need to define "prev" as a private variable outside of the scope of the method because we don't want it to change when we're doing recursion
